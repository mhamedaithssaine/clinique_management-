...
<html>
<head>
    <title>Ajouter un Utilisateur - Clinique</title>
...
<div class="container mx-auto px-6 py-8">
    ...
    <div class="flex items-center space-x-2 text-sm text-gray-600 mb-6">
        ...
        <span class="text-gray-800 font-medium">Ajouter un utilisateur</span>
    </div>

    <div class="flex justify-between items-center mb-8">
        <h1 class="text-4xl font-bold text-gray-800">Ajouter un utilisateur</h1>
    </div>
            ...
            <div class="p-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500">Choisissez un mot de passe sécurisé</p>
                    </div>
