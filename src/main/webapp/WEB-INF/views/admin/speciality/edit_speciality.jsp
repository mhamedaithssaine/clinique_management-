...
<html>
<head>
    <title>Éditer une spécialité - Clinique</title>
...
<div class="container mx-auto px-6 py-8">
    ...
    <div class="flex items-center space-x-2 text-sm text-gray-600 mb-6">
        <a href="${pageContext.request.contextPath}/admin/speciality" class="hover:text-purple-600 transition-colors">
            <i class="fas fa-stethoscope mr-1"></i>Spécialités
        </a>
        <i class="fas fa-chevron-right text-xs"></i>
        <span class="text-gray-800 font-medium">Éditer la spécialité</span>
    </div>

    <div class="flex justify-between items-center mb-8">
        <h1 class="text-4xl font-bold text-gray-800">Éditer la spécialité</h1>
    </div>
    ...
    <div class="glass-effect rounded-3xl shadow-xl overflow-hidden card-hover max-w-3xl mx-auto">
        ...
        <form action="${pageContext.request.contextPath}/admin/speciality/edit" method="post" class="p-8">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="description"
                              ...
                              placeholder="Décrivez les domaines d'intervention de la spécialité...">${speciality.description}</textarea>
                    ...
                    <select id="departmentId"
                        ...
                        <c:forEach var="department" items="${departments}">
                            <option value="${department.id}"
                                ${speciality.department.id == department.id ? 'selected' : ''}>
                                    ${department.name}
                            </option>
                        </c:forEach>
                    </select>
