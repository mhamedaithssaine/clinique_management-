...
<html>
<head>
    <title>Éditer un Utilisateur - Clinique</title>
...
<div class="container mx-auto px-6 py-8">
    ...
    <div class="flex items-center space-x-2 text-sm text-gray-600 mb-6">
        <a href="${pageContext.request.contextPath}/admin/users" class="hover:text-purple-600 transition-colors">
            <i class="fas fa-users mr-1"></i>Utilisateurs
        </a>
        <i class="fas fa-chevron-right text-xs"></i>
        <span class="text-gray-800 font-medium">Éditer un utilisateur</span>
    </div>

    <div class="flex justify-between items-center mb-8">
        <h1 class="text-4xl font-bold text-gray-800">Éditer un utilisateur</h1>
    </div>
    ...
    <!-- Form Card -->
    <div class="glass-effect rounded-3xl shadow-xl overflow-hidden card-hover max-w-6xl mx-auto">
        <form action="${pageContext.request.contextPath}/admin/users/edit" method="post">
            ...
            <div class="p-8">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="fullName" class="block text-sm font-medium text-gray-700 mb-2">
                            <i class="fas fa-user mr-2 text-purple-500"></i>Nom Complet
                    ...
                    <div>
                        <label for="password" class="block text-sm font-medium text-gray-700 mb-2">
                            <i class="fas fa-lock mr-2 text-purple-500"></i>Nouveau Mot de Passe
                        </label>
                        <input type="password" id="password" name="password"
                               class="input-field block w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all"
                               placeholder="Laisser vide pour garder l'actuel">
                        <p class="mt-1 text-xs text-gray-500">Laisser vide si vous ne souhaitez pas modifier</p>
                    </div>

                    <div>
                        <label for="role" class="block text-sm font-medium text-gray-700 mb-2">
                            <i class="fas fa-user-tag mr-2 text-purple-500"></i>Rôle
                            <span class="text-red-500 ml-1">*</span>
                        </label>
                ...
                <div class="mt-6">
                    <div class="flex items-center bg-gradient-to-r from-purple-50 to-blue-50 p-4 rounded-xl">
            ...
            <div id="patientFields" class="hidden">
                <div class="p-6 border-t border-b border-gray-200 bg-gradient-to-r from-purple-50 to-blue-50">
                    <h2 class="text-xl font-semibold text-gray-800 flex items-center">
                        <i class="fas fa-notes-medical mr-3 text-purple-600"></i>
                ...
                <div class="p-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                                <i class="fas fa-id-card mr-2 text-purple-500"></i>CIN
                            </label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                                <i class="fas fa-calendar mr-2 text-purple-500"></i>Date de Naissance
                            </label>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                                <i class="fas fa-venus-mars mr-2 text-purple-500"></i>Genre
                            </label>
                            <select name="gender" class="input-field block w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                                <i class="fas fa-tint mr-2 text-purple-500"></i>Groupe Sanguin
                            </label>
                            <select name="bloodType" class="input-field block w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all">
                        ...
                        <div class="md:col-span-2 lg:col-span-3">
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                                <i class="fas fa-map-marker-alt mr-2 text-purple-500"></i>Adresse
                            </label>
            ...
            <!-- Action Buttons -->
            <div class="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-4 p-8 pt-6 border-t border-gray-200">
                <a href="${pageContext.request.contextPath}/admin/users"
    ...
    <div class="mt-6 max-w-6xl mx-auto">
        <div class="bg-blue-50 border border-blue-200 rounded-xl p-4 flex items-start space-x-3">
            ...
            <div class="text-sm text-blue-800">
                ...
                <p>Si vous sélectionnez le rôle "Patient", des champs supplémentaires apparaîtront pour saisir les informations médicales.</p>
            </div>
        </div>
    </div>
</div>
